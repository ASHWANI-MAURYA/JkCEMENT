            ...
            <View style={{ marginHorizontal: 10, marginVertical: 10 }}>
              <View style={{ width: 180, height: 160 }}>
                <View style={{ padding: 25 }}>
                  <Text style={{ fontWeight: '600', fontSize: 19, color: '#ffffff' }}>Tota Student</Text>
          ...
          <View>
            <LinearGradient colors={['#90caf9', '#047edf',]}
              ...
              <View style={{ marginHorizontal: 10, marginVertical: 10 }}>
                <View style={{ width: 180, height: 160 }}>
                  <View style={{ padding: 25 }}>
                    <Text style={{ fontWeight: '600', fontSize: 19, color: '#ffffff' }}>Tota Teacher</Text>
          ...
          <View>
            <LinearGradient colors={['#84d9d2', '#07cdae',]}
              ...
              <View style={{ marginHorizontal: 10, marginVertical: 10 }}>
                <View style={{ width: 180, height: 160 }}>
                  <View style={{ padding: 25 }}>
                    <Text style={{ fontWeight: '600', fontSize: 19, color: '#ffffff' }}>Tota Parents</Text>
