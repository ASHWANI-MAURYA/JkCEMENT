      ...
      <View style={{ width: 'auto', }}>
        ...
        <View style={{ marginHorizontal: 10, marginVertical: 10 }}>
          <View style={{ marginTop: 10 }}>
            <Text style={{ fontSize: 16, fontWeight: '400' }}>First Name </Text>
            <TextInput placeholder='First Name ' style={{ marginTop: 18, borderWidth: 1, padding: 8 }} />
          </View>
          <View style={{ marginTop: 10 }}>
            <Text style={{ fontSize: 16, fontWeight: '400' }}>Last Name </Text>
          ...
          <View style={{ marginTop: 10 }}>
            <Text style={{ fontSize: 16, fontWeight: '400' }}>Father First Name</Text>
            <TextInput placeholder='Father First Name' style={{ marginTop: 18, borderWidth: 1, padding: 8 }} />
          </View>
          <View style={{ marginTop: 10 }}>
            <Text style={{ fontSize: 16, fontWeight: '400' }}>Father Last Name</Text>
            <TextInput placeholder='Father Last Name' style={{ marginTop: 18, borderWidth: 1, padding: 8 }} />
          </View>
          <View style={{ marginTop: 10 }}>
            <Text style={{ fontSize: 16, fontWeight: '400' }}>Mother First Name</Text>
            <TextInput placeholder='Father Last Name' style={{ marginTop: 18, borderWidth: 1, padding: 8 }} />
          </View>
          <View style={{ marginTop: 10 }}>
            <Text style={{ fontSize: 16, fontWeight: '400' }}>Mother Last Name</Text>
            <TextInput placeholder='Father Last Name' style={{ marginTop: 18, borderWidth: 1, padding: 8 }} />
          </View>
          <View style={{ marginTop: 10 }}>
            <Text style={{ fontSize: 16, fontWeight: '400' }}>Mobile</Text>
          ...
          <View style={{ marginTop: 10 }}>
            <Text style={{ fontSize: 16, fontWeight: '400' }}>Address</Text>
          ...
          <View style={{ marginTop: 10 }}>
            <Text style={{ fontSize: 16, fontWeight: '400' }}>Photo</Text>
            <Imagepicker />
          </View>
        </View>
        <View style={{ marginHorizontal: 10, marginVertical: 10 }}>
          ...
          <View style={{ marginTop: 10 }}>
            ...
            <View style={{ marginTop: 18 }}>
              <Text style={{ fontSize: 16, fontWeight: '400' }}>Class Section</Text>
              <View style={{ marginTop: 0 }}>
